      ...
      <div className="hidden lg:flex lg:w-1/2 relative h-screen overflow-hidden">
        ...
        <div className="absolute bottom-12 left-10 right-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[10px] tracking-[0.3em] uppercase text-[#C9A84C] font-semibold">Welcome Back</span>
          </div>
          ...
          <div className="flex gap-8 mt-8">
            {[{ n: '3', l: 'Bedrooms' }, { n: '8+', l: 'Amenities' }, { n: '24/7', l: 'Support' }].map(s => (
              <div key={s.l}>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-20 py-16 overflow-y-auto">
        ...
        <div className="max-w-md w-full mx-auto">
          <div className="mb-10">
            ...
            <h1 className="font-playfair text-4xl font-normal text-white mb-2">Sign In</h1>
            <p className="text-white/70 text-sm leading-relaxed">Sign in to manage your bookings at Comfort Service Apartment</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-[10px] tracking-[0.2em] uppercase text-white/70 mb-2">Email Address</label>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="block text-[10px] tracking-[0.2em] uppercase text-white/70">Password</label>
                <Link href="/forgot-password" className="text-[10px] text-[#C9A84C]/70 hover:text-[#C9A84C] transition-colors tracking-wide">
                  Forgot Password?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-white/70">
            ...
            <Link href="/signup" className="text-[#C9A84C] hover:text-[#d4b35a] transition-colors font-medium">
              Create Account
            </Link>
          </p>

          <div className="text-center mt-6">
            <Link href="/" className="text-[10px] text-white/70 hover:text-white/90 tracking-widest uppercase transition-colors">
              ← Back to Home
            </Link>
          </div>
        </div>
